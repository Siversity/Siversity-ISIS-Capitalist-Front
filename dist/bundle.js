...
function buyAngelUp(angel, world) {
    ...
    if ((angel.seuil <= world.totalangels) && (angel.unlocked == false)) {
        ...
        if (angel.idcible > 0) {
            ...
            var product = (0,___WEBPACK_IMPORTED_MODULE_4__.findProduct)(world, angel.idcible);
            ...
            (0,___WEBPACK_IMPORTED_MODULE_4__.applyBonusProduct)(product, angel.ratio, angel.typeratio);

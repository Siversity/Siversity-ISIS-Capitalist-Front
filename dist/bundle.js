...
function buyAngelUp(angel, world) {
    ...
    if ((angel.seuil <= world.totalangels) && (angel.unlocked == false)) {
        ...
        if (angel.idcible > 0) {
            ...
            angel.unlocked = true;
            (0,___WEBPACK_IMPORTED_MODULE_4__.applyBonusWorld)(world, angel.ratio, angel.typeratio);
        }

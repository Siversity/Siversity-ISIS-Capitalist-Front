...
function buyAngelUp(angel, world) {
    ...
    if ((angel.seuil <= world.activeangels) && (angel.unlocked == false)) {
        ...
        document.getElementById("angelNumber").innerHTML = (0,_App_Header__WEBPACK_IMPORTED_MODULE_0__.transform)(world.activeangels);

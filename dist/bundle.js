...
function buyCashUp(cashUp, world) {
    ...
    if ((cashUp.seuil <= world.money) && (cashUp.unlocked == false)) {
        ...
        (0,_RestCalls__WEBPACK_IMPORTED_MODULE_4__.sendToServer)("upgrade", cashUp);
    }
    else {
